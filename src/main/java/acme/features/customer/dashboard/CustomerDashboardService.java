...
public class CustomerDashboardService extends AbstractGuiService<Customer, CustomerDashboard> {
	...
	public void load() {
		...
		dashboard.setSpentMoney(new ArrayList<>());
		dashboard.setEconomyBookings(0);
		dashboard.setBusinessBookings(0);
		dashboard.setBookingTotalCost(new ArrayList<>());
		dashboard.setBookingAverageCost(new ArrayList<>());
		dashboard.setBookingMinimumCost(new ArrayList<>());
		dashboard.setBookingMaximumCost(new ArrayList<>());
		dashboard.setBookingDeviationCost(new ArrayList<>());

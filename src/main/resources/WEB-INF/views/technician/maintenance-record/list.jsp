...
<acme:list-column code="technician.maintenance-record.list.label.ticker" path="ticker" width="25%"/>
	<acme:list-column code="technician.maintenance-record.list.label.maintenanceMoment" path="moment" width="30%"/>
	<acme:list-column code="technician.maintenance-record.list.label.status" path="status" width="20%"/>
	<acme:list-column code="technician.maintenance-record.list.label.nextInspection" path="nextInspectionDueTime" width="30%"/>

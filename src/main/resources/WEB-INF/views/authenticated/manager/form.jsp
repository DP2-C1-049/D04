...
<acme:form>
	...
	<acme:input-integer code="authenticated.manager.form.label.yearsExperience" path="yearsExperience"/>
	<acme:input-moment code="authenticated.manager.form.label.birth" path="birth"/>
	<acme:input-textbox code="authenticated.manager.form.label.photo" path="photo"/>
